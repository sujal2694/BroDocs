...
const SigninPopUp = () => {
    ...
    return (
        <div>
            <LoginBar />
            <div className=' absolute top-0 left-0 w-[100vw] h-[100vh] bg-gradient-to-br from-blue-500/20 via-blue-400/20 to-orange-500/20 flex items-center justify-center flex-col z-10 '>
